...
<div class="topbar">
  <div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="section-title text-center">
						<h2>Our Platform</h2>
						<p>Initially freetimetutoring.com is UIU based as we can cover our university area. Our goal is to help the sudents with the studies with some following features like tuition arrangment , arranging group study , finding team member and resource sharing.</p>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-6 col-sm-6">
					<div class="about-text">
						<p>Almost every student of univeristy faces some problem with their studies equally. Based on their problem we designed our programs.</p>

						<ul class="withArrow">
							<li><span class="fa fa-angle-right"></span> Tuition arrangment.</li>
							<li><span class="fa fa-angle-right"></span> Group study arrangment.</li>
							<li><span class="fa fa-angle-right"></span> Finding team members.</li>
							<li><span class="fa fa-angle-right"></span> Sharing study resources.</li>
						</ul>
	...
	<div class="container">
	   <div class="row">
			<div class="col-md-12">
				<div class="aligncenter"><h2 class="aligncenter">Mission and Vision</h2>Our goal is to help the sudents with the studies with some features but also to buid communication , share knowledge and improve globally.</div>
				<br/>
			</div>
		</div>
			<div class="row">
		...
		<h3>Tuitor help</h3> <p>Imrovement in academic life will help a student to be more confident and capable for real life.</p></div>
		</div>
		<div class="col-md-3 text-center"> 
		<span class="icons c2"><i class="fa fa-users"></i></span> <div class="box-area">
		<h3>Community</h3> <p>A large tutor-student community of helping can make the environment of education more beautiful. </p></div>
		</div>
		<div class="col-md-3 text-center"> 
		<span class="icons c3"><i class="fa fa-trophy"></i></span> <div class="box-area">
		<h3>Achievments</h3> <p>If we can help the students with providing proper concept and better results , its an achievment for us .</p></div>
		</div>
		<div class="col-md-3 text-center"> 
		<span class="icons c4"><i class="fa fa-globe"></i></span> <div class="box-area">
		<h3>Thinking Globally</h3> <p>If we get enough support and good feedbacks from the users , we will broaden our service platform .</p>
		</div></div>
		</div></div>
		</div> 
