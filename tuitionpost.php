<?php
    ...
    $sql_post = "INSERT INTO post(Person_ID, Date_Time, Course_ID, Post_Description, Selected_Start_Date_Time, Selected_End_Date_Time, Selected_Payment,Post_Type, gender) values('$id', '$curdate', '$courseID', '$details', '$stime', '$etime', '$payment','$t', '$Gender' )";
		...
		<div class="row"> 
							<div class="col-md-12">
								<div class="about-logo">
									<h3>Find suitable tutor accordingly to your weakness</h3>
									<p>If you are looking for a tutor to help you in your studies then “Free time tutoring” is the perfect platform for you. Free time tutoring is giving you the opportunity to find quality tutors in budget on your own. To find a tutor you simply have to do a registration first and click on the ‘find a tutor’ option of ‘tuition arrangement’. Here you can post for a tutor by filling necessary fields.</p>
	...
	<div class="row">
        <div class="col-md-6">
            ...
            <div class="navbar-collapse collapse" style="background-color: #0c4270;">
                    <ul class="nav navbar-nav">
                        <li class="active" style="font-size: 17px;"><a href="#">Topic Wise</a></li>
                        <li><a href="tuitionpost1.php" style="font-size: 17px;">Hourly</a></li>
                        <li><a href="tuitionpost2.php" style="font-size: 17px;">Filter Tutor</a></li>
                    </ul>
                </div>
                </div>
		   ...
		   <!-- Form itself -->
              <form action="#" method="post">
                  ...
                  <div class="form-group">
                    <label for="exampleInputPayment" style="font-size: 17px;">Payment</label>
                  ...
                  <div class="form-group">
                        ...
                        <label for="exampleFormControlSelect1" style="font-size: 17px;">Enter End Time :  </label>
